...
const Main = () => {
  return (
    <section className="w-full h-full border-[2px] border-gray-500 dark:border-slate-300 rounded-xl py-10 px-32 backdrop-blur-3xl">
      <article className="h-full flex flex-col gap-5 overflow-auto text-2xl">
        ...
        <img
          className="w-[40%] mx-auto object-contain border border-gray-500 dark:border-slate-300"
          src="hazker.webp"
          alt="hazker"
        />
        <p>
